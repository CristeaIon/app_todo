          ...
          slivers: [
              ...
              child: OutlinedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      L.of(context).google(L.of(context).register),
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                  ],
                ),
              ...
              child: OutlinedButton(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Text(
                      L.of(context).apple(L.of(context).register),
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                  ],
                ),
            ...
            SliverToBoxAdapter(
              child: RichText(
                ...
                text: TextSpan(
                  text: L.of(context).alreadyHaveAccount,
